...
from task1_text_generation.data.generate_dataset import main as generate_corpus
from task2_chatbot.data.generate_qa_dataset import main as generate_qa
from task1_text_generation.train import train_all_text_gen_models
from task2_chatbot.train import train_all_chatbots
...
def main():
    ...
    task1_data_dir = os.path.join(PROJECT_ROOT, "task1_text_generation", "data")
    task2_data_dir = os.path.join(PROJECT_ROOT, "task2_chatbot", "data")
    ...
    corpus_path = os.path.join(task1_data_dir, "corpus.txt")
    ...
    qa_path = os.path.join(task2_data_dir, "qa_pairs.json")
